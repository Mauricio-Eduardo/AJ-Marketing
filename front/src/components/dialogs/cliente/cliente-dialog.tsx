  ...
  const onSubmit = async (pData: Cliente) => {
    ...
    try {
      if (action === "Cadastrar") {
        ...
        if (pData.situacao === "Aprovado") {
          toast.update(toastId, {
            render:
              "Não é possível excluir um cliente com o status de Aprovado!",
            type: "error",
            isLoading: false,
            draggable: true,
            draggableDirection: "x",
        ...
        <div className="flex flex-col gap-1 border-t-2 pt-4 border-gray-200">
          ...
          {interessesFields.map((field: any, index: any) => (
            ...
            >
              ...
              <Form.Field>
                <Form.Label htmlFor={`interesses.${index}.interesse` as const}>
                  Forma de Pagamento
                </Form.Label>
                <Form.Input
            ...
            >
              <Form.Field>
                ...
                <Form.Input
                  ...
                  disabled={action != "Cadastrar" && action != "Editar"}
                />
                <Form.ErrorMessage field={`ramos.${index}.ramo_id` as const} />
              </Form.Field>
            ...
            >
              ...
              <Form.Field>
                ...
                <Form.Input
                  ...
                  disabled={true}
                />
                <Form.ErrorMessage field={`usuarios.${index}.nome` as const} />
              </Form.Field>
              <Form.Field>
                ...
                <Form.Input
                  ...
                  disabled={true}
                />
                <Form.ErrorMessage field={`usuarios.${index}.email` as const} />
              </Form.Field>
              <Button
                type="button"
                color="red"
