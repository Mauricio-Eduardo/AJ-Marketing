...
export const UsuariosScreen = () => {
  ...
  const UsuariosColumns = React.useMemo<ColumnDef<IUsuarios>[]>(
    () => [
      {
        id: "select",
        size: 10,
  ...
  return (
    <div className="flex flex-col">
      <Dialog.Root onOpenChange={handleOpenModal}>
        ...
        >
          ...
          <Dialog.Trigger>
            <Button
              ...
              disabled={!selectedRowData.usuario_ID}
            >
              <Pencil />
              Editar
            </Button>
        ...
        <DataTable
          ChildModal={UsuarioDialog}
          columns={UsuariosColumns}
          action={action}
          onRowSelectionChange={handleRowSelectionChange}
          apiUrl="/GetAllUsuarios"
        />
      </Dialog.Root>
    </div>
  );
