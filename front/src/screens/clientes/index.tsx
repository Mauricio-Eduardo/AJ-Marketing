...
export const ClientesScreen = () => {
  ...
  const ClientesColumns = React.useMemo<ColumnDef<IClientes>[]>(
    () => [
      {
        id: "select",
        size: 10,
      ...
      },
      {
        id: "tipo_pessoa",
        size: 80,
        accessorFn: (row) => row.tipo_pessoa,
      ...
      },
      {
        ...
        header: () => <span>Nome/Razão Social</span>,
        cell: (info) => info.getValue(),
        footer: (props) => props.column.id,
      },
      {
  ...
  return (
    <div className="flex flex-col">
      <Dialog.Root onOpenChange={handleOpenModal}>
        ...
        >
          ...
          <Dialog.Trigger>
            <Button
              ...
              disabled={!selectedRowData.cliente_ID}
            >
              <Pencil />
              Editar
            </Button>
        ...
        <DataTable
          ChildModal={ClienteDialog}
          columns={ClientesColumns}
          action={action}
          onRowSelectionChange={handleRowSelectionChange}
          apiUrl="/GetAllClientes"
        />
      </Dialog.Root>
    </div>
  );
