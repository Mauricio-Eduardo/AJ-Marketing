        ...
        public IEnumerable<OrdemServicoModel> GetAllOrdensServico()
        {
            ...
            using (Connection)
            {
                try
                {
                    ...
                    "o.data_prazo, o.data_entrega, o.tema, o.referencia, o.situacao, o.postado, o.data_cadastro, o.data_ult_alt " +
        ...
        public string PutOrdemServico(OrdemServicoPutModel ordemAlterada)
        {
            using (Connection)
            {
                try
                {
                    ...
                    "referencia = @referencia, situacao = @situacao, postado = @postado, data_ult_alt = @data_ult_alt " +
